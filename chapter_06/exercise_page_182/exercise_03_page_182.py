...
Solution:
    - Cost:
    + When a call returns or completes its execution, the return address is used to locate the next instruction in
     the caller’s code, and the memory for the stack frame is deallocated.
